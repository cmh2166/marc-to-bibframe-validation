...
describe 'the work described by the MARC record' do
  ...
  # Cornell LD4All Sample MARC:
  # MARC fields that identify “a work described by the record”
  # This includes capturing core Work information (titles, type, issuance)
  # Uniform titles - not touched yet: 130
  # 100|110|111 and 240
  # 100|110|111 and 245
  # 245 (‡a) if no 1xx
  ...
  let(:marc_ldr_001_008) {
    '<record xmlns="http://www.loc.gov/MARC21/slim">
      ...
      <controlfield tag="005">RECORD_ADMIN_METADATA</controlfield>
  ...
  let!(:subtitle_of_work_sparql_query) {
    SPARQL.parse("PREFIX bf: <http://bibframe.org/vocab/>
                  ...
                  WHERE {
                    ...
                    ?subtitleElem a madsrdf:SubTitleElement ;
                      rdfs:label ?subtitle ;
                  }") }

=begin  context "130" do
